...
[Distributed Patrol Injector class]("./Assets/Examples/Custom Injectors/DistributingPatrolInjector.cs")
...
```
[Ranged Projectile full class]("./Assets/Examples/Custom State/RangedProjectile.cs")
...
[Ranged State]("./Assets/Examples/Custom State/RangedAttack.cs")
```cs
